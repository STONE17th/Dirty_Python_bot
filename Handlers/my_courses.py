...
# from Keyboards import create_ikb_my_courses
# import config
...
#     description = f'{name}, у тебя нет активных курсов!' if None in db.user_courses(
#         cur_chat) else f'{name}, это твои курсы!'
